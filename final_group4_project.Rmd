...
author: "Group 4: Patrick Cook, Sandra Matlievska, Nikita Reid, Shashvat Somany"
date: "`r Sys.Date()`"
output:
  html_document:
    theme: flatly
...
There is clearly a large discrepancy between certain types of merchant category and customer job in this data set. Let us combine the smallest represented categories of these into "Other" and convert the string variables to factors. This is much more useful for machine learning purposes and will enhance the predictive performance of our model:
